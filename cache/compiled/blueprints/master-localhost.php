...
return [
    ...
    'timestamp' => 1715024145,
    'checksum' => '34769cfbd182d97f7de84db4b1fcb8ef',
    'files' => [
        ...
        'user/themes' => [
            'themes/linktree-theme' => [
                'file' => 'user/themes/linktree-theme/blueprints.yaml',
                'modified' => 1715023732
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.linktree-theme.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.linktree-theme.dropdown',
                'form_field' => false
            ],
            'themes.linktree-theme.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.linktree-theme.dropdown.enabled',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'linktree-theme' => [
                    'dropdown' => [
                        'enabled' => 'themes.linktree-theme.dropdown.enabled'
                    ]
                ],
                'quark' => [
